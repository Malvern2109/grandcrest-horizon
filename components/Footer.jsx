        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          ...
          <div>
            ...
            <p className="text-blue-200 text-sm leading-relaxed max-w-xs">
              Innovating Ideas. Empowering Futures.<br/><br/>
              A Private Limited Company dedicated to developing impactful ventures and empowering youth.
            </p>
          </div>
          ...
          <div>
            ...
            <ul className="text-blue-200 text-sm space-y-3">
              ...
              <li className="flex items-center">
                ...
                <span>+263 787 370 842 / +263 713 038 105</span>
              </li>
              <li className="flex items-center">
